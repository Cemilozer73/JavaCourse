...
public class C04_PassByValueCokluElement {
    ...
    public static void main(String[] args) {
        ...
        elementlerini iki (2) katina cikarip yazdiran
        ...
        */
        ...
        /*
        verilen array' 10 degerini element olarak ekleyip
    ...
    public static void elementEkle(int[] arr2){
        ...
        for (int i = 0; i <arr2.length ; i++) {
            ...
            yeniArr[i] = arr2[i]; // Yeni array'in i'inci elementi = eski array'in i'inci elementine

        }
        yeniArr[yeniArr.length-1] = 10;

        arr2 = yeniArr; /* [3,4,5,10]eski arabayı yenisiyle degistirdigimiz icin
                                    Java bunu pass by value uygun bulmuyor
                                    main method'da call'dan once arr : [3, 4, 5]
                                        method'da arr2'nin yeni hali : [3, 4, 5, 10]
                                    main method'da call'dan sonra  arr : [3, 4, 5]
                                    */
