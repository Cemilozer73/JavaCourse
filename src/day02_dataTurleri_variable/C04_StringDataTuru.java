...
public class C04_StringDataTuru {
    public static void main(String[] args) {
        ...
        System.out.println(isim.toUpperCase()); //BERK YİLMAZ
        ...
        // iki tane String + isareti toplanmaya calisilirsa
        ...
        // ancak kodlar arasindaki bosluklar metne yansimaz.
        // System.out.println("Girilen "+             adi         + " " + soyadi +" database'e kaydedildi" );
