...
public class C03_primitiveDataTurleri {
    ...
    public static void main(String[] args) {
        ...
        // 1- boolean: mantiksal degerler olan true be false kabul eder
        boolean bl1=true;
        boolean bl2=false;
        ...
        // verilen iki sayinin carpim sonucunu yazdirin
        ...
        System.out.println("Verilen İki Sayinin Carpimi : " + sayi1*sayi2);
