...
public class C04_ArabaRunner {
    public static void main(String[] args) {
        ...
        System.out.println(araba1); // Araba bilgileri ==>
        // marka:'Marka belirtilmemis', model:'Model belirtilmemis',
        ...
        // o class'da instance variable'lara atana degerleri alir
        // sonra bizim her variable icin yeniden atama yapmamiz gerekir

        // Bunun yerine constructor call' parametre olarak degerler yazalim
